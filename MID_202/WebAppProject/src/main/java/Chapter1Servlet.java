...
public class Chapter1Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Chapter1Servlet</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            while (initServletParams.hasMoreElements()) {
                ...
                out.printf("<li>Servlet's init Parameter Name : %s, Value: %s</li>", nextElement, getInitParameter(nextElement));
            ...
            String msg = getInitParameter("greeting");
